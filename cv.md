...
<a class="pdf-frame cv-frame lang-en" href="{{ '/assets/pdf/cv-en.pdf' | relative_url }}" target="_blank" rel="noopener" title="Open the full CV (PDF)">
<picture>
<source type="image/webp" srcset="{{ '/assets/img/cv/cv-en-p1.webp' | relative_url }}">
<img src="{{ '/assets/img/cv/cv-en-p1.jpg' | relative_url }}" width="1632" height="2112" alt="Curriculum Vitae (English), page 1" loading="lazy">
</picture>
</a>
<a class="pdf-frame cv-frame lang-ko" href="{{ '/assets/pdf/cv-ko.pdf' | relative_url }}" target="_blank" rel="noopener" title="전체 이력서 열기 (PDF)">
<picture>
<source type="image/webp" srcset="{{ '/assets/img/cv/cv-ko-p1.webp' | relative_url }}">
<img src="{{ '/assets/img/cv/cv-ko-p1.jpg' | relative_url }}" width="1632" height="2112" alt="이력서 (한국어), 1쪽" loading="lazy">
</picture>
</a>
